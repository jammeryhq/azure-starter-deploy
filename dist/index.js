...
Object.defineProperty(exports, "__esModule", { value: true });
var read_dir_options_1 = __webpack_require__(174);
function deferred_error_with_data(done, fail, data, error, options) {
    if (read_dir_options_1.ReadDirOptions.IGNORE_ERRORS & options) {
        done(data);
    }
    else {
        fail(error);
...
exports.deferred_error_with_data = deferred_error_with_data;
function deferred_error(done, fail, error, options) {
    deferred_error_with_data(done, fail, [], error, options);
}
exports.deferred_error = deferred_error;
//# sourceMappingURL=deferred-error.js.map
...
var read_dir_1 = __webpack_require__(830);
exports.read = read_dir_1.read;
exports.readSync = read_dir_1.readSync;
exports.isDir = read_dir_1.isDir;
...
exports.fileStat = function (path) {
    return new Promise(function (done, fail) {
        fs_1.stat(path, function (err, result) {
            err ? fail(err) : done(result);
        });
    });
};
//# sourceMappingURL=file-stat.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var assert_1 = __webpack_require__(357);
var file_exists_1 = __webpack_require__(637);
var math_sum_1 = __webpack_require__(851);
var filters_1 = __webpack_require__(602);
var directory_1 = __webpack_require__(949);
var file_stat_1 = __webpack_require__(767);
...
function sum(input) {
    if (Array.isArray(input)) {
        return input.filter(isNumber).reduce(function (count, current) {
...
var fs_1 = __webpack_require__(747);
var file_exists_1 = __webpack_require__(637);
var deferred_error_1 = __webpack_require__(300);
var read_dir_options_1 = __webpack_require__(174);
/**
